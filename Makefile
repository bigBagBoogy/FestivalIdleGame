...
.PHONY: all test clean deploy payForScullies help install snapshot format anvil 
...
anvil :; anvil -m 'test test test test test test test test test test test junk' --steps-tracing --block-time 3
